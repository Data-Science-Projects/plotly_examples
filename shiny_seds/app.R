...
shiny_UI <- fluidPage(
  titlePanel("MSN by Year for all US Staes"),
  sidebarLayout(
    sidebarPanel(
      sliderInput("year", "Select a year:", 1960, 2014, 1000, step = 1, sep="", dragRange = FALSE),
      selectInput("msn", "Choose a MSN:",
                  list(`A` = c("ABICB - Aviation gasoline blending components consumed by the industrial sector.",
                       ...
                       `B` = c("BMTCB - Biomass total consumption"),
                       `C` = c("CCEXB - Coal coke exported from the United States. ",
                               ...
                               "CLKCP - Coal consumed at coke plants (coking coal).",
                       ...
                       `D` = c("DFACB - Distillate fuel oil consumed by the transportation sector.",
                               ...
                               "DFTCK - Factor converting distillate fuel oil physical units to Btu, United States only.",
                               ...
                               "DKEIP - Distillate fuel oil and kerosene-type jet fuel consumed by the electric power sector.",
                               "DKEIV - Distillate fuel oil and kerosene-type jet fuel expenditures in the electric power sector."),
                       `E` = c("ELEXB - Electricity exported from the United States.",
                               ...
                               "ELISB - Net interstate flow of electricity and associated losses (negative and positive values).",
                               "ELISP - Net interstate flow of of electricity.",
                               ...
                               "ESACP - Electricity consumed by (i.e., sold to) the transportation sector.",
                               ...
                               "ESCCP - Electricity consumed by (i.e., sold to) the commercial sector.",
                               ...
                               "ESRCP - Electricity consumed by (i.e., sold to) the residential sector.",
                               ...
                               "ESTXP - Electricity total end-use consumption (i.e., sold).",
                               "ESTXV - Electricity total end-use expenditures."),
                       `F` = c("FFETK - Fossil fueled steam-electric power plant conversion factor, United States only.",
                               "FFTCB - Fossil fuels, total consumption.",
                               "FNCAS - State's share of U.S. capacity of steam crackers using naptha as feedstocks.",
                               "FNICB - Petrochemical feedstocks, naphtha, less than 401o F, consumed by the industrial sector.",
                               "FNICD - Petrochemical feedstocks, naphtha less than 401 F, price in the industrial sector.",
                               "FNICP - Petrochemical feedstocks, naphtha less than 401o F, consumed by the industrial sector.",
                               "FNICV - Petrochemical feedstocks, naphtha less than 401 F, expenditures in the industrial sector.",
                               "FOCAS - State's share of U.S. capacity of steam crackers using other oils as feedstocks.",
                               "FOICB - Petrochemical feedstocks, other oils equal to or greater than 401o F, consumed by the industrial sector.",
                               "FOICD - Petrochemical feedstocks, other oils equal to or greater than 401o F, price in the industrial sector.",
                               "FOICP - Petrochemical feedstocks, other oils equal to or greater than 401o F, consumed by the industrial sector.",
                               "FOICV - Petrochemical feedstocks, other oils equal to or greater than 401o F, expenditures in the industrial sector.",
                               ...
                               "FSICP - Petrochemical feedstocks, still gas, consumed by the industrial sector.",
                               "FSICV - Petrochemical feedstocks, still gas, expenditures in the industrial sector."),
                       `G` = c("GDPRV - Current-dollar gross domestic product.",
                               ...
                               "GETCB - Geothermal energy, total consumed.",
                               "GETXB - Geothermal energy, total end-use consumption."),
                       `H` = c("HYCCB -	Hydropower consumed by the commercial sector.",
                               ...
                               "HYTCB - Hydropower, total consumed.",
                               "HYTCP - Hydroelectricity, total net generation.",
                               "HYTXB - Hydropower, total end-use consumption.",
                               "HYTXP - Hydroelectricity net generation, total end-use sectors."),
                       `J` = c("JFACB - Jet fuel consumed by the transportation sector.",
                               ...
                               "JKACP - Kerosene-type jet fuel consumed by the transportation sector.",
                               "JKTCB - Kerosene-type jet fuel total consumption.",
                               "JKTCP - Kerosene-type jet fuel total consumption.",
                               "JNACB - Naphtha-type jet fuel consumed by the transportation sector.",
                               "JNACP - Naphtha-type jet fuel consumed by the transportation sector.",
                               "JNTCB - Naphtha-type jet fuel total consumption.",
                               "JNTCP - Naphtha-type jet fuel total consumption."),
                       `K` = c("KSCCB - Kerosene consumed by the commercial sector.",
                        ...
                        `L` = c("LGACB - LPG consumed by the transportation sector.",
                                "LGACD - LPG price in the transportation sector.",
                                "LGACP - LPG consumed by the transportation sector.",
                                ...
                                "LGCCP - LPG consumed by the commercial sector.",
                                ...
                                "LGICK - Average conversion factor for industrial consumption of LPG, United States only.",
                                "LGICP - LPG consumed by the industrial sector.",
                                ...
                                "LGRCP - LPG consumed by the residential sector.",
                                ...
                                "LUTCV - Lubricants average price, all sectors.",
                        ...
                        `M` = c("MBICB - Motor gasoline blending components consumed by the industrial sector.",
                                "MBICP - Motor gasoline blending components consumed by the industrial sector.",
                                "MBTCK - Factor converting motor gasoline blending components physical units to Btu, United States only.",
                       ...
                       `N` = c("NAICB - Natural gasoline consumed by the industrial sector.",
                               "NAICP - Natural gasoline consumed by the industrial sector.",
                               ...
                               "NGCCP - Natural gas consumed by (delivered to) the commercial sector (including supplemental gaseous fuels).",
                               ...
                               "NGICP - Natural gas consumed by (delivered to) the industrial sector (including supplemental gaseous fuels).",
                               ...
                               "NGLPP - Natural gas consumed as lease and plant fuel.",
                               ...
                               "NGPZP - Natural gas for pipeline and distribution use.",
                               ...
                               "NGRCP - Natural gas consumed by (delivered to) the residential sector (including supplemental gaseous fuels).",
                               ...
                               "NGVHP - Natural gas consumed as vehicle fuel.",
                               ...
                               "NUETK - Factor for converting electricity generated from nuclear power from physical units to Btu, United States only.",
                               "NUETP - Nuclear electricity, total net generation.",
                               "NUETV - Nuclear fuel total expenditures."),
                       `P` = c("P1ICB - Asphalt and road oil, kerosene, lubricants, and \"other petroleum products\" consumed by the industrial sector.",
                               "P1ICD - Asphalt and road oil, kerosene, lubricants, and \"other petroleum products\" average price in the  industrial sector.",
                               "P1ICP - Asphalt and road oil, kerosene, lubricants, and \"other petroleum products\" consumed by the industrial sector.",
                               ...
                               "P1TCP - Asphalt and road oil, aviation gasoline, kerosene, lubricants, and \"other petroleum products\" total consumption.",
                               ...
                               "P1TXP - Asphalt and road oil, aviation gasoline, kerosene, lubricants, and \"other petroleum products\" total end-use consumption.",
                               ...
                               "PCCTK - Factor converting petroleum coke, catalyst coke physical units to Btu, United States only.",
                               ...
                               "PCICP - Petroleum coke consumed by the industrial sector.",
                               ...
                               "PCMKK - Factor converting petroleum coke, marketable coke physical units to Btu, United States only.",
                               ...
                               "PLICP - Plant condensate consumed by the industrial sector.",
                               ...
                               "POICP - Other petroleum products consumed by the industrial sector.",
                               ...
                               "POTCP - Other petroleum products total consumption.",
                               ...
                               "POTXP - Other petroleum products total end-use consumption.",
                               "POTXV - Other petroleum products total end-use expenditures.",
                               "PPICB - Pentanes plus consumed by the industrial sector.",
                               "PPICP - Pentanes plus consumed by the industrial sector."),
                       `R` = c("REPRB - Renewable energy production.",
                       ...
                       `S` = c("SFCCB - Supplemental gaseous fuels consumed by the commercial sector.",
                               ...
                               "SFTCB - Supplemental gaseous fuels total consumed.",
                               ...
                               "SOCCB - Photovoltaic and solar thermal energy consumed by the commercial sector (except portion included in SOHCB).",
                               "SOEGB - Photovoltaic and solar thermal energy consumed for electricity generation by the electric power sector.",
                               "SOEGP - Photovoltaic and solar thermal electricity net generation in the electric power sector.",
                               "SOHCB - Distributed photovoltaic and solar thermal energy consumed by the residential, commercial, and industrial sectors, other than power generated at commercial and industrial facilities with capacity of 1 megawatt or greater.",
                               "SOICB - Photovoltaic and solar thermal energy consumed by the industrial sector (except portion included in SOHCB).",
                               "SOTCB - Photovoltaic and solar thermal energy, total consumed.",
                               "SOTXB - Photovoltaic and solar thermal energy, total end-use consumption."),
                       `T` = c("TEACB - Total energy consumed by the transportation sector.",
                       ...
                       `U` = c("UOICB - Unfinished oils consumed by the industrial sector.",
                               "UOICP - Unfinished oils consumed by the industrial sector.",
                               "USICB - Unfractionated streams consumed by the industrial sector.",
                               "USICP - Unfractionated streams consumed by the industrial sector."),
                       `W` = c("UOICB - Unfinished oils consumed by the industrial sector.",
                               "UOICP - Unfinished oils consumed by the industrial sector.",
                               "USICB - Unfractionated streams consumed by the industrial sector.",
                               "USICP - Unfractionated streams consumed by the industrial sector.") 
                       )
...
shiny_server <- function(input, output) {
  ...
  all_states_long_df <- reactive({
    #This data is at Kaggle:
  ...
  plot_df <- reactive({ 
      msn <- substr(input$msn, 1, 5)
      year <- input$year
      df <- subset(all_states_long_df(), (MSN == msn & Year == year))
      df
    })
    
    output$map <- renderPlotly({
        plot_ly(z = ~plot_df()$value, locations = ~plot_df()$State, type = 'choropleth', locationmode = 'USA-states', color = plot_df()$value, colors = 'Blues', marker = list(line = borders)) %>%
         layout(title = paste(substr(input$msn, 1, 5), "-", input$year), geo = map_options())})
}
